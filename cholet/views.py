    ...
    if request.method == 'POST':
        ...
        if 'lead_consult_form' in request.POST:
            ...
            if form.is_valid():
                ...
                return redirect('/cholet/thank-you/')
                ...
                print('\n')
                print(form.cleaned_data)
                return render(request, 'cholet/index.html', context=context)
    else:
...
def pageServices(request):
    ...
    if request.method == 'POST':
        ...
        print('NOT in request POST')
        return render(request, 'cholet/all-services.html', context=context)
...
def pageArticles(request):
    ...
    if request.method == 'POST':
        ...
        print('NOT in request POST')
        return render(request, 'cholet/all-articles.html', context=context)

# --------------------------  GDPR Pages -------------


def mentions_lega(request):
    return render(request, 'cholet/mentions_legales.html')


def politique_conf(request):
    return render(request, 'cholet/politique_de_confidentialite.html')


def politique_cook(request):
    return render(request, 'cholet/politique_de_cookies.html')
...
def pageService_1(request):
    ...
    if request.method == 'POST':
        ...
        print('NOT in request POST')
        return render(request, 'cholet/service-1.html', context=context)
    ...
    if request.method == 'POST':
        ...
        if 'lead_consult_form' in request.POST:
            ...
            if form.is_valid():
                ...
                print('\n')
                print(form.cleaned_data)
                return render(request, 'cholet/service-beton-bordure.html', context=context)
    else:
        print('NOT in request POST')
        return render(request, 'cholet/service-beton-bordure.html', context=context)
    ...
    if request.method == 'POST':
        ...
        if 'lead_consult_form' in request.POST:
            ...
            if form.is_valid():
                ...
                print('\n')
                print(form.cleaned_data)
                return render(request, 'cholet/service-beton-cire.html', context=context)
    else:
        print('NOT in request POST')
        return render(request, 'cholet/service-beton-cire.html', context=context)
    ...
    if request.method == 'POST':
        ...
        if 'lead_consult_form' in request.POST:
            ...
            if form.is_valid():
                ...
                print('\n')
                print(form.cleaned_data)
                return render(request, 'cholet/service-beton-dalle.html', context=context)
    else:
        print('NOT in request POST')
        return render(request, 'cholet/service-beton-dalle.html', context=context)
    ...
    if request.method == 'POST':
        ...
        if 'lead_consult_form' in request.POST:
            ...
            if form.is_valid():
                ...
                print('\n')
                print(form.cleaned_data)
                return render(request, 'cholet/service-beton-decoratif.html', context=context)
    else:
        print('NOT in request POST')
        return render(request, 'cholet/service-beton-decoratif.html', context=context)
    ...
    if request.method == 'POST':
        ...
        if 'lead_consult_form' in request.POST:
            ...
            if form.is_valid():
                ...
                print('\n')
                print(form.cleaned_data)
                return render(request, 'cholet/service-beton-desactive.html', context=context)
    else:
        print('NOT in request POST')
        return render(request, 'cholet/service-beton-desactive.html', context=context)
    ...
    if request.method == 'POST':
        ...
        if 'lead_consult_form' in request.POST:
            ...
            if form.is_valid():
                ...
                print('\n')
                print(form.cleaned_data)
                return render(request, 'cholet/service-beton-imprime.html', context=context)
    else:
        print('NOT in request POST')
        return render(request, 'cholet/service-beton-imprime.html', context=context)
    ...
    if request.method == 'POST':
        ...
        if 'lead_consult_form' in request.POST:
            ...
            if form.is_valid():
                ...
                print('\n')
                print(form.cleaned_data)
                return render(request, 'cholet/service-bitume.html', context=context)
    else:
        print('NOT in request POST')
        return render(request, 'cholet/service-bitume.html', context=context)
    ...
    if request.method == 'POST':
        ...
        if 'lead_consult_form' in request.POST:
            ...
            if form.is_valid():
                ...
                print('\n')
                print(form.cleaned_data)
                return render(request, 'cholet/service-fondation.html', context=context)
    else:
        print('NOT in request POST')
        return render(request, 'cholet/service-fondation.html', context=context)
    ...
    if request.method == 'POST':
        ...
        if 'lead_consult_form' in request.POST:
            ...
            if form.is_valid():
                ...
                print('\n')
                print(form.cleaned_data)
                return render(request, 'cholet/service-pavage.html', context=context)
    else:
        print('NOT in request POST')
        return render(request, 'cholet/service-pavage.html', context=context)
    ...
    if request.method == 'POST':
        ...
        if 'lead_consult_form' in request.POST:
            ...
            if form.is_valid():
                ...
                print('\n')
                print(form.cleaned_data)
                return render(request, 'cholet/service-resine-sol-epoxy.html', context=context)
    else:
        print('NOT in request POST')
        return render(request, 'cholet/service-resine-sol-epoxy.html', context=context)
    ...
    if request.method == 'POST':
        ...
        if 'lead_consult_form' in request.POST:
            ...
            if form.is_valid():
                ...
                print('\n')
                print(form.cleaned_data)
                return render(request, 'cholet/service-terrasse-gres-cerame.html', context=context)
    else:
        print('NOT in request POST')
        return render(request, 'cholet/service-terrasse-gres-cerame.html', context=context)
    ...
    if request.method == 'POST':
        ...
        if 'lead_consult_form' in request.POST:
            ...
            if form.is_valid():
                ...
                print('\n')
                print(form.cleaned_data)
                return render(request, 'cholet/service-terrasse-pierre-naturelle.html', context=context)
    else:
        print('NOT in request POST')
        return render(request, 'cholet/service-terrasse-pierre-naturelle.html', context=context)
...
def pageArticle_1(request):
    ...
    if request.method == 'POST':
        ...
        print('NOT in request POST')
        return render(request, 'cholet/article-1.html', context=context)
# --------------------------  Thank You Pages -------------


def thankYouCholet(request):
    return render(request, 'cholet/index-thank-you.html')
...
def send_email_lead_consult(form, http_header):
    ...
    sentence = 'Here is your new lead for MIR Béton - Cholet\n' + 'First Name: ' + first_name + '\n' + 'Last Name: ' + last_name + '\n' + \
        'Email: ' + email + '\n' + 'Phone: ' + phone + '\n' + \
        'Zip Code: ' + zipcode + '\n' + 'Work Type: ' + work_type + '\n' + \
        'Surface: ' + surface + '\n' + 'IP Address: ' + remote_ip

    send_mail('New Consult Lead From MIR Beton Cholet!', sentence, from_email=settings.EMAIL_HOST_USER,
